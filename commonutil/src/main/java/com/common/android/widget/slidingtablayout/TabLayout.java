...
package com.common.android.widget.slidingtablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.tab_layout_text_size);
        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.tab_layout_tab_min_width);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private int mIndicatorCorner = 0;
...
//                    canvas.drawRect(left, getHeight() - mSelectedIndicatorHeight, right, getHeight(), mSelectedIndicatorPaint);
                    ...
                    //todo 修改为圆角
                    RectF oval = new RectF(left, getHeight() - mSelectedIndicatorHeight, right, getHeight());
                    canvas.drawRoundRect(oval, mIndicatorCorner, mIndicatorCorner, mSelectedIndicatorPaint);
...
//                    canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight, mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                    ...
                    RectF oval = new RectF(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight, mIndicatorRight, getHeight());
                    canvas.drawRoundRect(oval, mIndicatorCorner, mIndicatorCorner, mSelectedIndicatorPaint);
        ...
        public void setIndicatorCorner(int indicatorCorner) {
            this.mIndicatorCorner = indicatorCorner;
        }
    ...
    public void setTabIndicatorCorner(int corner) {
        mTabStrip.setIndicatorCorner(corner);
    }
