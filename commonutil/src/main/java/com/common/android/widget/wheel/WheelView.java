...
package com.common.android.widget.wheel;
...
import com.common.android.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xefd9d9d9,
			0xcff9f9f9, 0x3ff9f9f9 };
