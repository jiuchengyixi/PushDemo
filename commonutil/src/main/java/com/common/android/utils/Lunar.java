...
/**
 * Created by yuanht on 2017/11/21.
 * 农历
 */
public class Lunar {
...
//        System.out.print(d.getTime().getMonth()+ "月");
        ...
        System.out.println("节日：" + l.isFestival());
        System.out.println("节日：" + l.getLFestivalName());
        System.out.println("节日：" + l.getSFestivalName());
...
//        }
    ...
    public final static String[] weekString = {
            "日", "一", "二", "三", "四", "五", "六"
    };
    /**
     * 国历节日 *表示放假日
    ...
    public String getWeek() {
        return weekString[this.solar.get(Calendar.DAY_OF_WEEK) - 1];
    }
