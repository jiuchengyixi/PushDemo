...
public abstract class DateUtil {
     ...
     * yyyy
     */
    public static final String LYEAR_FORMAT = "yyyy";
    /**
     * yyyyMM
     */
    public static final String LMONTH_FORMAT = "yyyyMM";
    ...
    private static final ThreadLocal<SimpleDateFormat> lYearThreadLocal =
            new ThreadLocal<SimpleDateFormat>() {
                @Override
                protected SimpleDateFormat initialValue() {
                    return new SimpleDateFormat(LYEAR_FORMAT);
                }
            };
    private static final ThreadLocal<SimpleDateFormat> lMonthThreadLocal =
            new ThreadLocal<SimpleDateFormat>() {
                @Override
                protected SimpleDateFormat initialValue() {
                    return new SimpleDateFormat(LMONTH_FORMAT);
                }
            };
    ...
    private static Date parser(DateFormat format, String dateString) {
        try {
    ...
    public static Date parseDateTime(String date) {
        return parser(dateTimeThreadLocal.get(), date);
    }
    ...
    public static Date parseDate(String date) {
        return parser(dateThreadLocal.get(), date);
    }
    ...
    public static Date parseLDate(String date) {
        return parser(lDateThreadLocal.get(), date);
    }
    ...
    public static Date parseYear(String date) {
        return parser(lYearThreadLocal.get(), date);
    }
     ...
     * @return
     */
    public static Date parseLMonth(String date) {
        return parser(lMonthThreadLocal.get(), date);
    }
    ...
    public static Date parseDate(String date, String format) {
        ...
        return parser(new SimpleDateFormat(format), date);
    }
     ...
     * @return yyyy
     */
    public static String formatLYear(Date date) {
        return format(lYearThreadLocal.get(), date);
    }
    ...
    public static Date firstDayOfMonth(Date date) {
        Calendar calendar = org.apache.commons.lang3.time.DateUtils.toCalendar(dayStart(date));
    ...
    public static Date endDayOfMonth(Date date) {
        Calendar calendar = org.apache.commons.lang3.time.DateUtils.toCalendar(dayEnd(date));
    ...
    public static long getTodayUnix() {
        ...
        try {
            ...
            date = sdf.parse(sdf.format(new Date())).getTime() / 1000;
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return date;
     ...
     * 明天时间戳
     */
    public static long getTomorrowUnix() {
        long date = 0;
        ...
        try {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            date = sdf.parse(sdf.format(cal.getTime())).getTime() / 1000;
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return date;
     ...
     * 今年时间戳
     */
    public static long getYearUnix() {
        long date = 0;
