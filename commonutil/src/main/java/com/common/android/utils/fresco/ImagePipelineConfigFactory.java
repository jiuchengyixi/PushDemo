...
public class ImagePipelineConfigFactory {
     ...
     * 使用Android自带的网络加载图片
     */
    public static ImagePipelineConfig getImagePipelineConfig(Context context, File imageCacheDir, boolean openLog) {
     ...
     * 使用OkHttp网络库加载图片
     */
    public static ImagePipelineConfig getOkHttpImagePipelineConfig(Context context,  File imageCacheDir, boolean openLog) {
    ...
    private static void configureCaches(ImagePipelineConfig.Builder configBuilder, Context context) {
        ...
        //当内存紧张时采取的措施
        final MemoryTrimmableRegistry memoryTrimmableRegistry = NoOpMemoryTrimmableRegistry.getInstance();
