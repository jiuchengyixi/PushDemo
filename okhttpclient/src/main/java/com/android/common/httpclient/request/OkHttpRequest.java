...
public abstract class OkHttpRequest {
    ...
    public static class Builder {
        ...
        public Builder tempFileDir(String tempFileDir) {
        ...
        public OkHttpRequest get(ResultCallback callback) {
            ...
            try {
                ...
                OkHttpClientManager.getInstance().sendFailResultCallback(request.request, e, callback);
            }
            return request;
        }
...
//            }
        ...
        public OkHttpRequest download(ResultCallback callback, boolean resume) {
            if (resume) {
                File tempFile = new File(tempFileDir + File.separator + destFileName);
                long startPos = 0;
                if (tempFile.exists()) {
            ...
            OkHttpRequest request = new OkHttpDownloadRequest(url, tag, params, headers, tempFileDir, destFileName, destFileDir, resume);
            request.invokeAsyn(callback);
            return request;
        }

        public String download() throws IOException {
            OkHttpRequest request = new OkHttpDownloadRequest(url, tag, params, headers, tempFileDir, destFileName, destFileDir, false);
